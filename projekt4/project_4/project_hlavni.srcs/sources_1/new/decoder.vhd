...
begin
    ...
    p_cnt : process(ce_i, inp_mez)
    begin
   		if rising_edge(ce_i) then
        	
            if (reset = '1' or rising_edge(inp_mez)) then
    ...
    p_clear_led : process(inp_tran, inp_mez)
    begin 
    	if (reset = '1' or rising_edge(inp_tran)) then
        LED <= "000000000000000";
        
        
        elsif rising_edge(inp_mez) then
